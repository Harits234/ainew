...
st.title("📈 AI TRADING THE PIPS MAFIA")
...
if st.button("Daftar & Jalankan Bot"):
    if len(st.session_state.telegram_ids) >= 5:
        ...
        send_telegram_message(telegram_input, f"🚀 Bot Scalping aktif! Anda akan menerima sinyal realtime untuk pair *{pair}* berdasarkan strategi MA50/200.")
